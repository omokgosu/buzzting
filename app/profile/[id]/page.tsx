        ...
        >
          ...
          {profile.instagramUrl && (
            <a
              ...
              className="flex items-center justify-between px-4 py-3 mb-6 bg-gradient-to-r from-[#fff5f5] via-[#fff8f5] to-[#fffaf5] rounded-xl border border-[#f0e0e0] hover:border-[#e8d0d0] transition-colors"
            >
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-sm text-[#5C4A37]">인스타도 하고 있어요</span>
              </div>
              <span className="text-xs text-[#C4956A]">구경가기 →</span>
            </a>
          )}
