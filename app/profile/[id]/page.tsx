        ...
        >
          ...
          <div className="space-y-6">
            ...
            {profile.instagramUrl && (
              <div className="space-y-4">
                <h2 className="text-base font-semibold text-[#5C4A37] border-b border-[#E8DDD4] pb-2">인스타그램</h2>
                <a
                  href={profile.instagramUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-white text-sm rounded-full font-medium hover:opacity-90 transition-opacity"
                >
